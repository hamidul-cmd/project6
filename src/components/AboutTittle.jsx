...
function AboutTittle({ tittle, pera }) {
  return (
    <>
      <section className="relative">
        <h2 className="text-[28px] font-semibold leading-150 mb-1.5 xll:text-[38px] xll:mb-2.5 text-white 3xl:text-5xl 3xl:leading-150 3xl:mb-3.5 relative z-20">
          {tittle}
        </h2>
        <p className="text-sm leading-150 font-medium text-gray-60 xll:text-base xll:leading-150 3xl:text-lg 3xl:leading-150 max-w-[1297px]">
          {pera}
        </p>
