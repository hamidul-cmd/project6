...
function Tittle({ tittle, pera1, pera2, button }) {
  return (
    <>
      <section className="mb-10 relative xll:flex xll:justify-between xll:items-end xll:mb-14.5">
        <div className="text-white xll:w-[975px] relative z-20">
          <h2 className="text-[28px] font-semibold leading-150 mb-1.5 xll:text-[38px] xll:mb-2.5">
            {tittle}
          </h2>
          <p className="text-sm leading-150 font-medium text-gray-60 xll:text-base xll:leading-150">
            {pera1}
            <span className="hidden xll:inline-block">{pera2}</span>
          </p>
        </div>
        <div className="hidden xll:block">
          {button && <Link className="black block">{button}</Link>}
        </div>
        <div className="absolute top-[-19px] left-[-8px] xll:left-[-10px] xll:top-[-24px] z-10">
          <svg
